 ...
 */
const CLIENT_ID = '536877219459-d4hgi1oc4doi2dojql6go32em5k05f4m.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = '94YaqTay5IUpHTpD1Kk0mR5K';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "ASE project";

$client = new Google_Client();
$client->setApplicationName(ASE project);
